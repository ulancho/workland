...
<div class="page-wrapper">
    ...
    <!-- MENU SIDEBAR-->
    <aside class="menu-sidebar d-none d-lg-block hidden">
        <div class="logo">
            <a href="#">
                <img src="<?=base_url()?>public/images/icon/logo.png" alt="Cool Admin" />
            </a>
        </div>
        <div class="menu-sidebar__content js-scrollbar1">
            <nav class="navbar-sidebar">
                <ul class="list-unstyled navbar__list">
                    <li>
                        <a href="<?=base_url()?>admin/MainSections/vacancy">
                            <i class="fas fa-chart-bar"></i>Вакансии</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>admin/MainSections/programms">
                            <i class="fas fa-table"></i>Программы</a>
                    </li>
                </ul>
            </nav>
        </div>
                                ...
                                <div class="account-item clearfix js-item-menu">
                                    ...
                                    <div class="account-dropdown js-dropdown">
                                        <div class="account-dropdown__footer">
                                            <a href="<?=base_url()?>admin/Admin_page/logout">
